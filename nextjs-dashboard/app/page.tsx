...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col p-6">
      {/* 这是css module 在css文件定一一个css规则名称 然后在js里import 然后再通过属性去访问css 并作为class属性附加到元素中 */}
      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          ...
          <Image src="/hero-mobile.png" width={560} height={620} className="hidden md:block" alt="Screenshots of the dashboard project showing desktop version" />
        </div>
      </div>
    </main>
  );
